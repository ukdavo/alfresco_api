...
class ActivitiesApi(object):
    ...
    def list_activities_for_person(self, person_id, **kwargs):  # noqa: E501
        """List activities  # noqa: E501

        Gets a list of activities for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_activities_for_person(person_id, async_req=True)
        >>> result = thread.get()
        ...
        :param str who: A filter to include the user's activities only `me`, other user's activities only `others`' 
        :param str site_id: Include only activity feed entries relating to this site.
        ...
        if kwargs.get('async_req'):
            return self.list_activities_for_person_with_http_info(person_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_activities_for_person_with_http_info(person_id, **kwargs)  # noqa: E501
            return data

    def list_activities_for_person_with_http_info(self, person_id, **kwargs):  # noqa: E501
        """List activities  # noqa: E501

        Gets a list of activities for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_activities_for_person_with_http_info(person_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['person_id', 'skip_count', 'max_items', 'who', 'site_id', 'fields']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_activities_for_person" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('person_id' not in params or
            ...
            raise ValueError("Missing the required parameter `person_id` when calling `list_activities_for_person`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ActivityPaging',  # noqa: E501
