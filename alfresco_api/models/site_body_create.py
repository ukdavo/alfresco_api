...
class SiteBodyCreate(object):
    ...
    def __init__(self, id=None, title=None, description=None, visibility='PUBLIC'):  # noqa: E501
        """SiteBodyCreate - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._title = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SiteBodyCreate, dict):
